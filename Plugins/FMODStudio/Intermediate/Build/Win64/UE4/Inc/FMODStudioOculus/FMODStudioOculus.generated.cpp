...
static struct FScriptStruct_FMODStudioOculus_StaticRegisterNativesFFMODOculusRoomParameters
{
	...
	IMPLEMENT_CLASS(UFMODOculusBlueprintStatics, 2329207784);
	...
	UClass* Z_Construct_UClass_UFMODOculusBlueprintStatics()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFMODOculusBlueprintStatics_SetRoomParameters(), "SetRoomParameters"); // 3089936461
