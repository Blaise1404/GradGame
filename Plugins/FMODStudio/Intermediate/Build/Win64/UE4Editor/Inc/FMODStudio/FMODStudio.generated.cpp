...
void EmptyLinkFunctionForGeneratedCodeFMODStudio() {}
	...
	IMPLEMENT_CLASS(UFMODAudioComponent, 1993649310);
	void AFMODAmbientSound::StaticRegisterNativesAFMODAmbientSound()
	{
	}
	IMPLEMENT_CLASS(AFMODAmbientSound, 628803880);
...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODEventInstance
{
	...
	IMPLEMENT_CLASS(UFMODBlueprintStatics, 4216106081);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFMODSpeakerMode(EFMODSpeakerMode_StaticEnum, TEXT("/Script/FMODStudio"), TEXT("EFMODSpeakerMode"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(UFMODSettings, 1694810723);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	uint32 Get_Z_Construct_UScriptStruct_FFMODEventInstance_CRC() { return 3672169786U; }
	...
	UClass* Z_Construct_UClass_UFMODBlueprintStatics()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetTransform(), "EventInstanceSetTransform"); // 2822869213
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFMODBlueprintStatics_FindAssetByName(), "FindAssetByName"); // 1121588991
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFMODBlueprintStatics_FindEventByName(), "FindEventByName"); // 3046108344
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFMODBlueprintStatics_PlayEventAtLocation(), "PlayEventAtLocation"); // 1927995299
